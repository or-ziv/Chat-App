...
export default function Notification() {
    ...
    const unreadNotifications = unreadNotificationsFuncion(notifications!);
                ...
                <div className="notifications-box">
                    <div className="notifications-header">
                        ...
                        <div className="mark-as-read"
                            onClick={() => { if (notifications && markAllNotificationsAsRead) markAllNotificationsAsRead(notifications) }}>
                            Mark all as read
                        </div>
                    </div>
                    ...
                    {modifiedNotifications && modifiedNotifications.map((n, index) => {
                        return <div
                            ...
                            onClick={() => {
                                if (markNotificationAsRead && userChats && user && notifications) {
                                    markNotificationAsRead(userChats, user, notifications, n)
                                };
                                setIsOpen(!isOpen)
                            }}
                        >
